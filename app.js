...
var new_users = ["user2", "user3", "user6", "user7", "user8"];
new_users.forEach(function (new_users) {
    if (current_users.some(function (current_users) { return current_users.toLowerCase() === new_users.toLowerCase(); })) {
        console.log("Dear ".concat(new_users, ", you will need to enter a new username."));
    }
    else {
        console.log("Dear ".concat(new_users, ", the username is available."));
    }
});
